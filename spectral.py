...
# FIXED: Removed 'phantom_rate' and 'clustering_coeff'
FEATURE_NAMES = [
    "spread_ratio", "hub_focus", "relation_entropy",
    "review_length", "spectral_gap", 
]
...
def extract_features(review, paper_data):
    ...
    # FIXED: Removed dead liang_alpha code, phantom_rate, and clustering_coeff
    return [
        spread_ratio, hub_focus, relation_entropy,
        review_length, gap,
    ]
...
def main():
    ...
    if len(ai_X) > 0:
        ...
        for i, name in enumerate(FEATURE_NAMES):
            ...
            print(f"{name:<20} {h_mean:<12.4f} {a_mean:<12.4f} " f"{delta:+<10.4f} {d:<10.4f} {effect} {direction}")
